...
assert_file_contains "$HOME_NIX" "tinted-theming/tinty/config.toml" "home.nix declares Tinty config"
assert_file_contains "$HOME_NIX" "preferred-schemes" "Tinty config uses preferred-schemes schema"
assert_file_contains "$HOME_NIX" "base16-mocha" "Tinty config includes dark scheme"
assert_file_contains "$HOME_NIX" "base16-gruvbox-light-medium" "Tinty config includes light scheme"
assert_file_contains "$HOME_NIX" "base16-rose-pine" "Tinty config includes Rose Pine"
assert_file_contains "$HOME_NIX" "base16-rose-pine-moon" "Tinty config includes Rose Pine Moon"
assert_file_contains "$HOME_NIX" "base16-rose-pine-dawn" "Tinty config includes Rose Pine Dawn"

assert_file_contains "$HOME_NIX" "dx-theme" "home.nix declares dx-theme"
assert_file_contains "$HOME_NIX" "dx-theme-copy-hook" "home.nix declares Tinty copy hook"
assert_file_contains "$HOME_NIX" "dx-theme-osc-hook" "home.nix declares Tinty OSC hook"
assert_file_contains "$HOME_NIX" "dx-theme-restore" "home.nix declares Tinty login restore"
...
assert_file_contains "$HOME_NIX" "tinted-tmux" "Tinty tmux item is configured"
assert_file_contains "$HOME_NIX" "tinted-lazygit" "Tinty lazygit item is configured"
...
assert_file_contains "$HOME_NIX" "dx-theme-write-tool-themes" "tool theme writer is installed"
...
assert_file_contains "$HOME_NIX" 'dx-theme-write-tool-themes" "$current"' "activation refreshes tool themes for existing theme"
